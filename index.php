...
<div class="w-75 mx-auto mt-5">
    <div class="row justify-content-center mt-5">
      <div class="col-12">
        <a href="viewrecords.php" class="btn btn-info w-100">View Record</a>
      </div>
    </div>
</div>
...
<div class="w-75 mx-auto mt-2">
  <form class="row g-3" method="POST" action="delete.php">
    ...
    <div class="col-2">
      <input type="text" class="form-control" id="inputKey" name="deleteKey" placeholder="Primary Key" style="background-color:honeydew">
    </div>
    

    <div class="col-10">
      <button type="submit" class="btn btn-primary w-100" style="background-color:red; border-color:red">Delete Record</button>
    </div>
  </form>
</div>
